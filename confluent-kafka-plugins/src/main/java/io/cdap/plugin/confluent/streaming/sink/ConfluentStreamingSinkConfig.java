...
public class ConfluentStreamingSinkConfig extends ReferencePluginConfig implements Serializable {
  ...
  /**
   * Constructor for ConfluentStreamingSinkConfig object.
   * @param referenceName the reference name
   * @param brokers the broker
   * @param async the asynchronous
  ...
  /**
   * Verifies required details of base source configuration for Confluent.
  ...
  /**
   * Return the map of kafka properties.
   * @return the map of kafka properties
   */
