...
public class ConfluentStreamingSourceConfig extends ReferencePluginConfig implements Serializable {
   ...
   * @param partitions the partition
   * @param initialPartitionOffsets the initial partition offsets
   * @param defaultInitialOffset the default initial offset
  ...
  /**
   * Validates {@link ConfluentStreamingSourceConfig} instance.
   * 
   */
